...
// Built-in demo website used when Anna LLM is unavailable / returns non-JSON.
// Generated by scripts/generate-fixture.js
import DEMO_WEBSITE from "./mock-data.js";
...
async function handleSend() {
  ...
  try {
    ...
    if (text.startsWith("/vibe")) {
      ...
      if (!parsed) {
        addMsg("tool", "↩ Anna LLM unavailable — loading built-in demo site");
        parsed = DEMO_WEBSITE;
      }
